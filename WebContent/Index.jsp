                     ...
                     <div class="collapse navbar-collapse" id="navbarsExample04">
                        <ul class="navbar-nav mr-auto">
                           ...
                           <li class="nav-item">
                             ...
                             <li class="nav-item">
                              <a class="nav-link link__action" href="Login.jsp" style="color:#fff;background-color: #fe0000; padding: 3px;
                           ...
                           <li class="nav-item">
                              <a class="nav-link link__action" href="Register.jsp" style="color:#fff;background-color: #fe0000; padding: 3px;
							    border: 1px solid orange;
							    border-radius: 4px;">Register</a>
                           </li>
                        </ul>
