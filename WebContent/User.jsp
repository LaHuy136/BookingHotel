...
<body class="main-layout">
         ...
         <div class="row">
            <div class="col-md-4 col-sm-6">
               <div id="serv_hover" class="room">
                  ...
                  <div class="bed_room">
                    <h3>
                    <a href="RoomDetail.jsp?RoomName=<%= roomArray.get(0).getName() %>
                    		&RoomID=<%= roomArray.get(0).getRoomID() %>
                    		&Price=<%= roomArray.get(0).getPrice() %>">
                   	 	<%= roomArray.get(0).getName() %>
                    </a>
                    </h3>
                      <p><b>Type:</b> <%= roomArray.get(0).getType() %></p>
                       <p><b>Price:</b> <%= roomArray.get(0).getPrice() %>$</p>
                        <p><b><%= roomArray.get(0).getDescription() %></b></p>
                        <p><b>Available:</b> <%= roomArray.get(0).getAvailability() %></p>
                  </div>
               </div>
            </div>
            <div class="col-md-4 col-sm-6">
               <div id="serv_hover" class="room">
                 ...
                 <div class="bed_room">
                     <h3><%= roomArray.get(2).getName() %></h3>
                      <p><b>Type:</b> <%= roomArray.get(2).getType() %></p>
                       <p><b>Price:</b> <%= roomArray.get(2).getPrice() %>$</p>
                        <p><b><%= roomArray.get(2).getDescription() %></b></p>
                        <p><b>Available:</b> <%= roomArray.get(2).getAvailability() %></p>
                  </div>
               </div>
            </div>
            <div class="col-md-4 col-sm-6">
               <div id="serv_hover" class="room">
                  ...
                  <div class="bed_room">
                     <h3><%= roomArray.get(1).getName() %></h3>
                      <p><b>Type:</b> <%= roomArray.get(1).getType() %></p>
                       <p><b>Price:</b> <%= roomArray.get(1).getPrice() %>$</p>
                        <p><b><%= roomArray.get(1).getDescription() %></b></p>
                        <p><b>Available:</b> <%= roomArray.get(1).getAvailability() %></p>
                  </div>
               </div>
            </div>
            <div class="col-md-4 col-sm-6">
   ...
   <!-- end footer -->
      ...
      <script>
    function redirectToRoomDetail(roomID) {
        window.location.href = 'RoomDetail.jsp?roomID=' + roomID;
    }
</script>
</body>
